      ...
      <KeyboardAwareScrollView>
        ...
        <View style={styles.Container2}>
          <TextInput
            ...
            mode="outlined"
            outlineColor={Colors.UniLInkPrimary} // Setting the color
            activeOutlineColor={Colors.UniLInkPrimary}
          ...
          <View>
            <TextInput
              ...
              mode="outlined"
              outlineColor={Colors.UniLInkPrimary}
              activeOutlineColor={Colors.UniLInkPrimary}
              right={
                <TextInput.Icon
        ...
        <View style={styles.ImportContainer3}>
          <Text style={styles.newPatientText}>Are you a new Student? </Text>
